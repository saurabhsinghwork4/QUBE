# -*- coding: utf-8 -*-
"""Deploy_testing_Final_Working_QB19022025.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EutDsm47DlXTGwqTE4n1aF9q3jSS0Zl1
"""
        ...
        with gr.Tabs():  # ✅ Use gr.Tabs as a wrapper
            ...
            with gr.Tab("Generate Complete Question Bank"):
              ...
              def generate_exam_questions_complete(course_code, course_title, lesson_plan):
                  ...
                  merged_excel_filepath = f"/content/drive/MyDrive/Question_bank_dataset/QUBE_Data/complete_QB/Complete_QB_{course_code}.xlsx"
                  ...
                  local_excel_filepath = f"/content/{course_code}.xlsx"
                  shutil.copy(merged_excel_filepath, local_excel_filepath)
                  files.download(local_excel_filepath)
